...
def get_tokenizer():
    if cs.SPM_TYPE == 'length':
        tokenizer = spm.SentencePieceProcessor('spm_incl_note_lengths.model')
    elif cs.SPM_TYPE == 'duration':
        tokenizer = spm.SentencePieceProcessor('spm_incl_note_duration_commands.model')
    elif cs.SPM_TYPE == 'include_note_offs':
        tokenizer = spm.SentencePieceProcessor('spm_incl_note_offs.model')
    elif cs.SPM_TYPE == 'exclude_note_offs':
        tokenizer = spm.SentencePieceProcessor('spm_excl_note_offs.model')
