            ...
            for L in new_track.all_iterables_with_time_events():
                for event in L:
                    ...
                    if hasattr(event, 'end'):
                        raise ValueError('ByMeasureTrack does not support events with "end" events')
...
class MidiSong(object):
    @classmethod
    def from_midi_file(cls, path_to_file):
        import miditoolkit
    ...
    def __init_cleanup_time_sigs(self):
        """in place operation"""
