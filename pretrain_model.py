...
EPOCHS = range(0, 5)
BATCH_SIZE = (11, 12)  # BATCH_SIZE[0] = per-device train batch size; BATCH_SIZE[1] = # of gradient accumulation steps
CLEANUP_PRETRAIN_DATA = True  # If True, deletes files created by build_pretrain_data after they are no longer needed.
